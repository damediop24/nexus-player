...
def get_download_path(folder_id: int, filename: str, root_dir: str = "downloads") -> str:
    # Support absolute path via BOT_DOWNLOAD_DIR env (used when integrated in Nexus Player
    # so TG downloads land directly in the shared top-level downloads/ and appear in the Library).
    root_dir = os.getenv("BOT_DOWNLOAD_DIR", root_dir)
